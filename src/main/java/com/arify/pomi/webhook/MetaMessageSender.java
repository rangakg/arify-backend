...
public class MetaMessageSender {
                                ...
                                "interactive", Map.of(
                                                ...
                                                "action", Map.of(
                                                                ...
                                                                "parameters", Map.of(
                                                                                ...
                                                                                "url",
                                                                                "https://arifysolutions.co.in/book?t="
                                                                                                + token))));
        ...
        public void sendTwoButtons(String to,
                        String message,
                        String paymentText,
                        String changeText,
                        String token) {
                                ...
                                "interactive", Map.of(
                                                ...
                                                "action", Map.of(
                                                                ...
                                                                "parameters", Map.of(
                                                                                ...
                                                                                "url",
                                                                                "https://arifysolutions.co.in/payments?t="
                                                                                                + token))));

                restTemplate.postForEntity(url, new HttpEntity<>(paymentBody, headers), String.class);

                // -----------------------
                // BUTTON 2 → CHANGE SLOT
                // -----------------------
                Map<String, Object> changeBody = Map.of(
                                "messaging_product", "whatsapp",
                                "to", to,
                                "type", "interactive",
                                "interactive", Map.of(
                                                "type", "cta_url",
                                                "body", Map.of(
                                                                "text", "Want to change your slot?"),
                                                "action", Map.of(
                                                                "name", "cta_url",
                                                                "parameters", Map.of(
                                                                                "display_text", changeText,
                                                                                "url",
                                                                                "https://arifysolutions.co.in/book?t="
                                                                                                + token))));

                restTemplate.postForEntity(url, new HttpEntity<>(changeBody, headers), String.class);
        }
